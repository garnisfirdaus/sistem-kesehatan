    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-neutral-500">
                Masukkan data untuk model prediksi kesehatan
            </p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="status_kesehatan" id="status_kesehatan" class="mt-1 block w-full py-2 px-3 border border-neutral-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm" required>
                            ...
                            <option value="Cukup Sehat" {{ old('status_kesehatan') == 'Cukup Sehat' ? 'selected' : '' }}>Cukup Sehat</option>
                            <option value="Perlu Perhatian" {{ old('status_kesehatan') == 'Perlu Perhatian' ? 'selected' : '' }}>Perlu Perhatian</option>
                        </select>
